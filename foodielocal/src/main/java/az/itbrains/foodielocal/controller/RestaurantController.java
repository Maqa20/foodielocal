...
public class RestaurantController {
    ...
    @PostMapping("/create")
    public String createRestaurant(@Valid @ModelAttribute Restaurant restaurant, BindingResult result, Model model) {
        if (result.hasErrors()) {
            model.addAttribute("restaurant", restaurant);
            return "restaurants/create";
        }
    ...
    @PostMapping("/edit/{id}")
    public String updateRestaurant(@PathVariable Long id, @Valid @ModelAttribute Restaurant restaurant, BindingResult result, Model model) {
        if (result.hasErrors()) {
            model.addAttribute("restaurant", restaurant);
            return "restaurants/edit";
        }
